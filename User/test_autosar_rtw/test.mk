...
## 
## Makefile     : test.mk
## Generated on : Sat Dec 31 13:11:08 2022
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\test_autosar_rtw;$(START_DIR)\test_autosar_rtw\stub;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\test_autosar_rtw\test.c $(START_DIR)\test_autosar_rtw\test_data.c
...
{$(START_DIR)\test_autosar_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_autosar_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_autosar_rtw\stub}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_autosar_rtw\stub}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
